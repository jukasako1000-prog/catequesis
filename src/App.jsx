...
const INITIAL_STUDENTS = [
  ...
  { id: 106, name: 'Enzo', totalScore: 0, dailyScore: 0, behaviorMedals: 0, readingMerits: 0, attendance: 0, avatar: 'AVATARES/enzo2.jpg' },
  { id: 108, name: 'J.FRANCISCO', totalScore: 0, dailyScore: 0, behaviorMedals: 0, readingMerits: 0, attendance: 0, avatar: 'AVATARES/josefrancisco2.jfif' },
  ...
  { id: 115, name: 'Emma', totalScore: 0, dailyScore: 0, behaviorMedals: 0, readingMerits: 0, attendance: 0, avatar: 'AVATARES/emma2.jpg' },
];
...
function App() {
  ...
  // Focus para SALA DE ESTUDIO (Temas y Actividades)
  const [aulaFocusIdx, setAulaFocusIdx] = useState(0);
                ...
                {aulaStep === 'themes' && (
                  <div className="aula-step-themes">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                      {Object.keys(AULA_TEMAS).map((tema, idx) => {
                        const isCompleted = completedThemes.includes(tema);
                        return (
                          <button
                            key={tema}
                            className="option-btn aula-option-btn-focusable"
                            style={{
                              height: 'auto',
                              padding: '20px',
                              display: 'flex',
